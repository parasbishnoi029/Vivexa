    ...
    <div className="space-y-8 pb-12 relative z-10 max-w-6xl mx-auto font-sans">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card className="bg-slate-900/40 border-slate-800/50 backdrop-blur-xl flex flex-col opacity-80 rounded-2xl">
          ...
          <CardContent className="flex-1 space-y-4">
            <ul className="space-y-2 text-sm text-slate-300">
              <li className="flex items-center gap-2"><Check className="h-4 w-4 text-slate-500" /> 3 Workspaces</li>
              <li className="flex items-center gap-2"><Check className="h-4 w-4 text-slate-500" /> Unlimited Datasets</li>
        ...
        <Card className="bg-slate-900/40 border-slate-800/50 backdrop-blur-xl flex flex-col rounded-2xl">
          ...
          <CardContent className="flex-1 space-y-4">
            <ul className="space-y-2 text-sm text-slate-300">
              ...
              <li className="flex items-center gap-2"><Check className="h-4 w-4 text-indigo-400" /> Advanced Analytics</li>
